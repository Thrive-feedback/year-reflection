...
const ButtonVariants = cva(
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl font-semibold text-[15px] leading-5 transition-all disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-purple-400 relative overflow-hidden",
  {
    variants: {
      variant: {
        contained: [
        ...
        outlined: [
          "border-2 border-purple-600/50 text-purple-600 bg-transparent hover:bg-purple-50",
        ],
